...
type Topics []db.Topic

func (t Topics) Tmpl() tmpl.Template {
	return tmpl.Associated("enhanced/index", "topics", t)
}
...
func (i Index) Tmpl() tmpl.Template {
	return tmpl.Wrap(&i.Layout, tmpl.Tmpl("enhanced/index", i))
}

func (t Topics) EmptyCells() []int {
	maxEmptyCells := 7
	if len(t) >= maxEmptyCells {
		return nil
	}
	var cells []int
	for i := range maxEmptyCells - len(t) {
		cells = append(cells, i)
	}
	return cells
}

func (t Topics) Gradient(id int) string {
